...
const MyButtonIcon = ({ children, type = "button", color, variant, size, rounded, disabled = false, onClick }) => {
    const makeStyle = React.useMemo(() => {
        ...
        if (color === "primary" && variant === "text") {
            ...
            className += (disabled) ? "text-gray-light/400 bg-gray-light/100 border border-gray-light/200 focus:outline-none"
                : "text-white bg-brand/600 hover:bg-brand/700 focus:outline-none focus:ring focus:ring-offset-0 focus:ring-[#f3e7bb]";
        } else if (color === "primary" && variant === "outlined") {
            className += (disabled) ? "text-gray-light/400 bg-white border border-gray-light/200 focus:outline-none"
                : "text-brand/700 hover:text-brand/800 bg-white hover:bg-brand/50 border border-brand/300 focus:outline-none focus:ring focus:ring-offset-0 focus:ring-[#f3e7bb]";
            ...
            className += " text-gray-light/700 border border-gray-light/300 bg-white shadow-shadows/shadow-xs focus:outline-none";
        }
